...
<head>
    ...
    <link rel="stylesheet" href="css/pagecliente.css">
...
<body>
    ...
    <header class="header">
        ...
        <a href="#" class="logo"> <i class="fas fa-shopping-basket"></i> Distribuidora E&E </a>
        ...
        <div id="noti">
            <pageacceso-component></pageacceso-component>
        </div>
        ...
        <div id="page">
            <pagelogin-component></pagelogin-component>
        </div>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Gran <span>variedad</span> de porductos para ti</h3>
            <p>Confia en nosostros tenemos los mejores porductos con los mejores precios </p>
    ...
    <section class="products" id="products">
        ...
        <div id="app">
            ...
            <pagecliente-component></pagecliente-component>
        </div>
    ...
    <!-- custom js file link  -->
    <script src="js/pagecliente.js"></script>
