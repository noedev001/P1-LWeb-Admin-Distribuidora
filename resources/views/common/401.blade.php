    ...
    ">
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3 p404 centered">
                ...
                <h3>La página que estás buscando usted no esta Autorizado</h3>
                <br>
                <div class="row">
                ...
                <h5 class="mt">Hey, tal vez te interesen estas páginas:</h5>
                <p><a href="home">Inicio</a> | <a href="users">Perfil</a> </p>
            </div>
        </div>
    </div>
