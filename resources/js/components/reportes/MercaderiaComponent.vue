<template>
    <section class="wrapper">
        ...
        <h3><i class="fa fa-angle-right"></i> Entrada de Mercaderia</h3>
     
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
                <h4><i class="fa fa-angle-right"></i> Nueva Mercaderia en el mes de {{mes | myDate5}}</h4>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr class="green">
                    ...
                    <th class="centered"><i class=" fa fa-dollar"></i> P. Compra U.</th>
    ...
    export default {
        ...
        created() {
             Fire.$on('searching',() => {
                        ...
                        axios.get('busquedamercaderia?q='+query)
                        .then((data) => {
                            this.mercaderia = data.data;
                        })
                        .catch(() => {
        ...
        methods: {
            ...
            LoadMercaderia(){
              axios.get('mercaderias').then(res => {
                        
                        this.mercaderia = res.data.mercaderia;
              ...
              swal
                ...
                .then((result) => {
                  ...
                  if (result.dismiss === swal.DismissReason.timer) {
                    axios
                      .post("pdfReportesentrada", params)
                      .then((data) => {
